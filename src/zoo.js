...
function oldestFromFirstSpecies(id) {
  ...
  const animal = animals.find(selectedanimal => selectedanimal.id === responsable.responsibleFor[0]);
  ...
  const oldestAnimal = animal.residents.find(oldestAnimal => oldestAnimal.age === maior);
