...
function animalMap(options) {
  ...
  // Valor com o parametro sorted e sex: um array de objetos com as especies e o nome delas ORDENADA e FILTRADA POR SEXO
  ...
  // 4. Se a opção includeNames estiver habilitada, retorna um array de objetos com as especies e o nome delas
  // 5. Se a opção sorted estiver habilitada, retorna um array de objetos com as especies e o nome delas ORDENADA
  // 6. Se a opção sex estiver habilitada, retorna um array de objetos com as especies e nome delas FILTRADA POR SEXO
...
function schedule(dayName) {
  // seu código aqui
  // Ao chamar a função sem parametros -> retorna um objeto com o cronograma inteiro
  // Ao chamar a função com 1 parametros (o dia da semana) -> retorna um objeto com o cronograma apenas do dia
